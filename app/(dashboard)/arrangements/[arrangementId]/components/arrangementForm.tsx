...
const AddArrangementForm = ({
  ...
  const form = useForm<ArrangementFormValues>({
    ...
    defaultValues: initialData
      ? {
          ...initialData,
          deceased: initialData.deceased.id,
          crossSize: 'deprecated',
          dateOfFuneralService: initialData.dateOfFuneralService
          ...
          graveNo: initialData.graveNo ? initialData.graveNo : '',
          graveId: initialData.graveId
            ? initialData.graveId
            : '6616593b149f9c78856cc0d2',
          crossSizeId: initialData.crossId
            ? initialData.crossId
            : '6674a59457d812d09c7f7aff',
          tombstoneId: initialData.tombstoneId
            ? initialData.tombstoneId
            : '66158c06a8cfcff52ed32d68',
          coffinId: initialData.coffinId
            ? initialData.coffinId
            : '6614467780ae4f6405b2faeb',
          updatedBy: '',
  ...
  useEffect(() => {
    calculateTotal();
  }, [discount, coffinFee, tombstoneFee, crossFee, storageFee]);
