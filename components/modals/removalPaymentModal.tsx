...
const RemovalPaymentModal = () => {
  ...
  const onSubmit = async (data: RemovalReceiptFormValues) => {
    ...
    data.outstandingBalance =
      individualData.outstandingBalance - data.receivedAmount;
    ...
    try {
      ...
      await axios.post(`/api/removal/receipt/${removalId}`, data);
...
export default RemovalPaymentModal;
